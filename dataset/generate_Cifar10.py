"""
Generate Cifar10 dataset for VPFL
...
if __name__ == "__main__":
    ...
    generate_dataset("Cifar10_5_pat/", num_clients=5, partition_type='pat')
    
    # 10 clients, dirichlet partition
    generate_dataset("Cifar10_10_dir/", num_clients=10, partition_type='dir', alpha=0.1)
